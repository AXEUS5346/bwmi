...
const SECTIONS = [
  ...
  },
  {
    title: 'Manage an LLP',
    links: [
      { label: 'LLP Name Reservation — Form 25', to: '/efiling/Form-25' },
      { label: 'LLP Name Application — Form 23', to: '/efiling/Form-23' },
      { label: 'LLP Name Change — Form 5', to: '/efiling/Form-5' },
      { label: 'LLP Agreement — Form 3', to: '/efiling/Form-3' },
      { label: 'LLP Partner Change — Form 4', to: '/efiling/Form-4' },
      { label: 'LLP Registered Office — Form 15', to: '/efiling/Form-15' },
      { label: 'LLP Address Intimation — Form 12', to: '/efiling/Form-12' },
      { label: 'Foreign LLP Registration — Form 27', to: '/efiling/Form-27' },
    ],
  },
  {
    title: 'File & Comply',
    links: [
      ...
      { label: 'LLP Annual Return — Form 11', to: '/efiling/Form-11' },
      { label: 'LLP Solvency — Form 8', to: '/efiling/Form-8' },
      { label: 'LLP Agreement — Form 3', to: '/efiling/Form-3' },
      { label: 'LLP Partner Change — Form 4', to: '/efiling/Form-4' },
      { label: 'LLP Address Intimation — Form 12', to: '/efiling/Form-12' },
      { label: 'LLP Intimation of Order — Form 22', to: '/efiling/Form-22' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'LLP Strike Off — Form 24', to: '/efiling/Form-24' },
      { label: 'Company Conversion — INC-27', to: '/efiling/INC-27' },
      { label: 'Firm to LLP — Form 17', to: '/efiling/Form-17' },
      { label: 'Company to LLP — Form 18', to: '/efiling/Form-18' },
